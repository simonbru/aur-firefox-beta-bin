...
source=("https://archive.mozilla.org/pub/firefox/releases/142.0b4/linux-x86_64/en-US/firefox-$pkgver.tar.xz"
        "$_pkgname.sh"
        "$pkgname.desktop"
        "policies.json")
sha256sums=('66823e2f80974db68d71ae893505a7d796ca1f20a3f977cf959b23cfeeb7fe71'
