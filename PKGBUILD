...
source=("https://archive.mozilla.org/pub/firefox/releases/141.0b4/linux-x86_64/en-US/firefox-$pkgver.tar.xz"
        "$_pkgname.sh"
        "$pkgname.desktop"
        "policies.json")
sha256sums=('04e66e3e8a7512d2f45b69fe9385c6820182e7b8addfaac218ee10a108a08e6b'
