...
source=("https://archive.mozilla.org/pub/firefox/releases/140.0b8/linux-x86_64/en-US/firefox-$pkgver.tar.xz"
        "$_pkgname.sh"
        "$pkgname.desktop"
        "policies.json")
sha256sums=('1fa8bcb1e242ffbad091b3ee7067ece582d34508db394e656832ab07b058e96e'
