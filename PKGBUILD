...
source=("https://archive.mozilla.org/pub/firefox/releases/139.0b5/linux-x86_64/en-US/firefox-$pkgver.tar.xz"
        "$_pkgname.sh"
        "$pkgname.desktop"
        "policies.json")
sha256sums=('5ff7ed52bf658b78b80595629096f12a16951ebb702da9a0dce9b02b14421976'
