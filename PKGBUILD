...
source=("https://archive.mozilla.org/pub/firefox/releases/139.0b2/linux-x86_64/en-US/firefox-$pkgver.tar.xz"
        "$_pkgname.sh"
        "$pkgname.desktop"
        "policies.json")
sha256sums=('c53561c12640003b6c1d3c2112e73227451f8e0a956b65be46cd1ca783e6efe1'
