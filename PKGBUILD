...
source=("https://archive.mozilla.org/pub/firefox/releases/140.0b3/linux-x86_64/en-US/firefox-$pkgver.tar.xz"
        "$_pkgname.sh"
        "$pkgname.desktop"
        "policies.json")
sha256sums=('c1428da2dfc7a16deb7b9570fcccba94c13158373a359804233a4b5f330746a0'
