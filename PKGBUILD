...
source=("https://archive.mozilla.org/pub/firefox/releases/138.0b3/linux-x86_64/en-US/firefox-$pkgver.tar.xz"
        "$_pkgname.sh"
        "$pkgname.desktop"
        "policies.json")
sha256sums=('7f57c9de156ed8dbd509c99d55b6c303dcd097cd5cca4a02264f59a12b72723b'
