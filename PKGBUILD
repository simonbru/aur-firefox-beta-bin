...
source=("https://archive.mozilla.org/pub/firefox/releases/141.0b2/linux-x86_64/en-US/firefox-$pkgver.tar.xz"
        "$_pkgname.sh"
        "$pkgname.desktop"
        "policies.json")
sha256sums=('0d60ea31ec38fed508fbfc6105af7cc86f564a8e21f464fd91e8bcc44c48e040'
