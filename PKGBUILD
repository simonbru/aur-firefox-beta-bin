...
source=("https://archive.mozilla.org/pub/firefox/candidates/137.0b1-candidates/build1/linux-x86_64/en-US/firefox-$pkgver.tar.xz"
        "$_pkgname.sh"
        "$pkgname.desktop"
        "policies.json")
sha256sums=('98848e14e857a3562c4a2cf6fbbf7966e4f256cf6e127df0b367ac23c6638676'
