...
source=("https://archive.mozilla.org/pub/firefox/releases/$pkgver/linux-x86_64/en-US/firefox-$pkgver.tar.xz"
        "$_pkgname.sh"
        "$pkgname.desktop"
        "policies.json")
sha256sums=('acc392fd3b9711d2ee749366f6adf86e38cba8e3dda6bd77cc01ad603f5a2418'
