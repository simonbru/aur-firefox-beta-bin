...
source=("https://archive.mozilla.org/pub/firefox/releases/138.0b9/linux-x86_64/en-US/firefox-$pkgver.tar.xz"
        "$_pkgname.sh"
        "$pkgname.desktop"
        "policies.json")
sha256sums=('a9b83684f6fa9eecf29c79119bab9239c4255ac53ce12126ced524cc8c7da758'
