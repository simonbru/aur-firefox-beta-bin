...
source=("https://archive.mozilla.org/pub/firefox/releases/141.0b5/linux-x86_64/en-US/firefox-$pkgver.tar.xz"
        "$_pkgname.sh"
        "$pkgname.desktop"
        "policies.json")
sha256sums=('4ec09ae2ec30059da53aed013f530a0b759f2a3e902719b9523b63713b394826'
